...
export default function ScanVisualizationActive({ target, nmapType = 'basic', onComplete, onReportPhase, externalDone = {}, externalRunning = {}, generatingReport = false, reportDev = null, reportNonDev = null, devChunkLen = 0, nondevChunkLen = 0, topOffset = 0 }) {
