...
```json
{
  ...
  "tools_run": ["shodan", "whatweb", "dns_whois", "http_headers", "nvd_lookup"],
  "tool_errors": ["ssl_tls: can't subtract offset-naive and offset-aware datetimes", "dns_whois: crt.sh lookup failed — 404 Client Error: Not Found for url: https://crt.sh/?q=%25.google.com&output=json"],
  "open_ports": [80, 443],
  "services": {
  ...
  "ssl": {
    ...
    "issues": ["ssl_tls tool errored — no SSL data collected", "Shodan flagged self-signed certificate on 142.250.189.142"]
  },
  "http_headers": {
